...
public class Oval extends Shape {
    protected java.awt.Point[]  definingPoints = new java.awt.Point[2]; //Contains 2 points: upper left point and lower right point of the bounding box
    protected Color     outlineColor;
    protected int       outlineWidth;
    protected boolean   filled;
    protected Color     fillColor;
    protected boolean   rotated                 = false;    //Initially oval is not rotated
    protected float     angle                   = 0.0f;

    public Oval(java.awt.Point first, java.awt.Point second, Color outlineColor, int outlineWidth, boolean filled, Color fillColor, boolean rotated, float angle) {
    ...
    public Oval(java.awt.Point[] points, State state) throws Exception {
        if (points.length != 2) {
            throw new Exception("Can't construct oval from number of points differing from 2");
        }
    ...
    public String getDescription() {
        String description = "1 "; // 1 corresponds to oval
